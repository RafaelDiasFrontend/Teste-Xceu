            ...
            <v-container class='box-01'>
                ...
                <ul class='social-midia-contact pa-0 pt-5'>                  
                    <li class='d-flex align-center py-3'>
                        <img src='~/assets/imagens/icons/phone-icon.png' alt="icon_facebook" height="25px" width="auto" class='mr-3'>
                        <span class='white--text span-text'>+55 (21) 2442-3443</span>                         
                    </li>
                    <li class='d-flex align-center py-3'>
                        <img src='~/assets/imagens/icons/email-icon.png' alt="icon_facebook" height="25px" width="auto" class='mr-3'>
                        <span class='white--text span-text'>franquia@grupoastral.com.br</span>                         
                    </li>                  
                    <li class='d-flex align-center py-3'>
                        <img src='~/assets/imagens/icons/facebook-logo.png' alt="icon_facebook" height="25px" width="auto" class='mr-3'>
                        <span class='white--text span-text'>facebook.com/astralsaudeambiental</span>                         
                        </li>
                    <li class='d-flex align-center py-3'>
                        <img src='~/assets/imagens/icons/instagram_icon.svg' alt="icon_facebook" height="25px" width="auto" class='mr-3'>
                        <span class='white--text span-text'>instagram.com/grupoastral</span>                         
                    </li> 
                    <li class='d-flex align-center py-3'>
                        <img src='~/assets/imagens/icons/linkedin_icon.svg' alt="icon_facebook" height="25px" width="auto" class='mr-3'>
                        <span class='white--text span-text'>Linkedin.com/company/astral-sa-de-ambiental</span>                         
                    </li>                  
                </ul>     
               <vue-recaptcha 
                class='pt-9'
